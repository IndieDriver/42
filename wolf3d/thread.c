...
/*   Updated: 2016/02/21 14:12:40 by amathias         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	multi_thread(t_map *map, void *function)
{
	...
	a1 = init_thread(map, getpos(0,0), getpos(WIDTH / 4,0));
	a2 = init_thread(map, getpos(WIDTH / 4, 0), getpos(WIDTH / 4 * 2, 0));
	a3 = init_thread(map, getpos(WIDTH / 4 * 2, 0), getpos(WIDTH / 4 * 3, 0));
	a4 = init_thread(map, getpos(WIDTH / 4 * 3, 0), getpos(WIDTH, 0));
