...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/02/20 11:54:56 by amathias          #+#    #+#             */
/*   Updated: 2016/02/20 12:20:33 by amathias         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	get_iter(t_complex *z, t_complex *old, int max_iter)
{
	...
	{
		*old = *z;
		z->real = old->real * old->real - old->ima * old->ima - 0.123;
		z->ima = 2 * old->real * old->ima + 0.745;
		i++;
